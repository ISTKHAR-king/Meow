...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("SUHANIMUSIC/assets/thumb/font2.ttf", 30)
        meta_font = ImageFont.truetype("SUHANIMUSIC/assets/thumb/font.ttf", 22)
    ...
    # Icons
    try:
        icons_path = "SUHANIMUSIC/assets/thumb/play_icons.png"
